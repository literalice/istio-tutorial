...
istioctl create -f istiofiles/virtual-service-recommendation-v1_and_v2_50_50.yml -n $TUTORIAL_PROJECT
----
...
[source,bash]
----
istioctl replace -f istiofiles/destination-rule-recommendation_cb_policy_version_v2.yml -n $TUTORIAL_PROJECT

istioctl get destinationrule -n $TUTORIAL_PROJECT
----
...
[source,bash]
----
istioctl delete virtualservice recommendation -n $TUTORIAL_PROJECT
istioctl delete -f istiofiles/destination-rule-recommendation_cb_policy_version_v2.yml -n $TUTORIAL_PROJECT
----
...
[source,bash]
----
oc scale deployment recommendation-v2 --replicas=2 -n $TUTORIAL_PROJECT
oc get pods -w

or

kubectl scale deployment recommendation-v2 --replicas=2 -n $TUTORIAL_PROJECT
kubectl get pods -w
----
...
[source,bash]
----
istioctl replace -f istiofiles/destination-rule-recommendation_cb_policy_pool_ejection.yml -n $TUTORIAL_PROJECT
----
...
or
kubectl scale deployment recommendation-v2 --replicas=1 -n $TUTORIAL_PROJECT
kubectl delete pod -l app=recommendation,version=v2


istioctl delete virtualservice recommendation -n $TUTORIAL_PROJECT
istioctl delete destinationrule recommendation -n $TUTORIAL_PROJECT
----
