...
[source,bash]
----
siege -r 2 -c 20 -v `oc get routes customer -o jsonpath --template '{.spec.host}'`
----
...
[source,bash]
----
istioctl replace -f istiofiles/virtual-service-recommendation-v1_and_v2_retry.yml -n $TUTORIAL_PROJECT
----
